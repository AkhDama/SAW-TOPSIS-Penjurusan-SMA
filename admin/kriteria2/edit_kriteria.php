...
?>
      <main class="main">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="../kriteria2">Kriteria</a></li>
          <li class="breadcrumb-item active">Ubah</li>
        </ol>
        <?php  
          $tampilkriteria = mysqli_query($mysqli, "SELECT * FROM kriteria2 where Id_Kriteria = $idkriteria");
                ...
                <div class="card">
                  ...
                  <form action="edit_kriteria_action.php" method="post">
                    <div class="card-body">
                      ...
                      <div class="col-sm-6">
                        <a class="btn btn-outline-info btn-lg btn-block" href="../kriteria2">Batal</a>
                      </div>
                      </div>
                    </div>
                  </form>
