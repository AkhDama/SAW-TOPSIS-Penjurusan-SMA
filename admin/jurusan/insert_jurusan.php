                ...
                <div class="card">
                  ...
                  <form action="insert_jurusan_action.php" method="post">
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        <label for="vat">Kuota Laki-Laki</label>
                        <input class="form-control" id="vat" type="number" placeholder="Kuota Laki" name="kuota_L">
                      </div>
                      <div class="form-group">
                        <label for="vat">Kuota Perempuan</label>
                        <input class="form-control" id="vat" type="number" placeholder="Kuota Perempuan" name="kuota_P">
                      </div>
