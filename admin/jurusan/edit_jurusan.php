                  ...
                  <form action="edit_jurusan_action.php" method="post">
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input class="form-control" id="vat" type="text" name="kuota_L" value="<?php echo $jurusan['P']; ?>">
                      </div>
                      <div class="form-group">
                        <label for="vat">Kuota Perempuan</label>
                        <input class="form-control" id="vat" type="text" name="kuota_P" value="<?php echo $jurusan['L']; ?>">
                      </div>
